...
title('x-position of particle 1')
xlabel('time (ms)')
ylabel('x (mm)')
...
xlabel('time (ms)')
ylabel('y (mm)')
title('y-position of particle 1')
...
xlabel('time (ms)')
ylabel('x (mm)')
title('x-position of particle 2')
...
xlabel('time (ms)')
ylabel('y (mm)')
title('y-position of particle 2')
...
xlabel('time (ms)')
ylabel('x (mm)')
title('x-position of particle 3')
print(gcf,'x-position of particle 3.png','-dpng','-r1000')

figure(6)
legend(Legend)
xline(delta_t)
title('y-position of particle 3')
xlabel('time (ms)')
ylabel('y (mm)')
