...
function Scan_Compare_1D_2D_Cluster(D_0_input)
D_0_matrix=str2double(D_0_input);
...
%%
file_name_pc=['2021.2.17_scan_pc_D_0=',num2str(D_0)];
...
runs=10;
Scan_compare_Viktor(D_0,dt,50000,linspace(1.1,3.2,30),delta_t_matrix_vik,runs,file_name_vik)
...
% Scan_compare_PC(D_0,dt,delta_t_matrix,theta_0_1D_matrix,10^5,file_name_pc,intrinsic_delay)
