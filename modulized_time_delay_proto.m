...
function modulized_time_delay_proto(N,delta_t,dt,Obs_time_steps,v_0,T,magnify,control_animation_interval,movie_create,ghost,axis_choice,x_init,y_init)
% clear;
% close all
...
% magnify=1
% control_animation_interval=10^4
% movie_create='on'
% ghost='off'
