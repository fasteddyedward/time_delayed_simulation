...
%             cutoff_mask(i,:)=cutoff(1./AratesV_plot(i,:),1/tV_max);
            ...
            plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateN_plot(i,:).*pre_mask(i,:).*cutoff_mask(i,:),'-.g')
            plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateA_plot(i,:).*pre_mask(i,:).*cutoff_mask(i,:),'--r')
            plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateAeff_plot(i,:).*pre_mask(i,:).*cutoff_mask(i,:),':b')
            plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateNeff_plot(i,:).*pre_mask(i,:).*cutoff_mask(i,:),':m')
        end
        if D_0_index==length(D_0_matrix)
%         v = [5 2 5];
        v = [1 0 0]
...
%         sim=plot(1,1,'kx')
        ...
        for i=1:length(delta_t_matrix_vik)
            ...
            plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateN_plot(i,:).*pre_mask(i,:).*cutoff_mask(i,:),'-.g')
            plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateA_plot(i,:).*pre_mask(i,:).*cutoff_mask(i,:),'--r')
%             plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateAeff_plot(i,:).*pre_mask(i,:),':b')
%             plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateNeff_plot(i,:).*pre_mask(i,:),':m')
        end
        if D_0_index==length(D_0_matrix)
%         v = [5 2 5];
        v = [1 0 0]
...
%         sim=plot(1,1,'kx')
        ...
        for i=1:length(delta_t_matrix_vik)
            error=5*10^-2;
            pre_mask(i,:)=pre_filter(rateAeff_plot(i,:),rateNeff_plot(i,:),error);
%             plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateN_plot(i,:).*pre_mask(i,:),'-.g')
%             plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateA_plot(i,:).*pre_mask(i,:),'--r')
            plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateAeff_plot(i,:).*pre_mask(i,:).*cutoff_mask(i,:),':b')
            plot3(ones(length(AvN_plot))*D_0*delta_t_matrix_vik(i),AvN_plot,1./AratesV_plot(i,:)./rateNeff_plot(i,:).*pre_mask(i,:).*cutoff_mask(i,:),':m')
        end
        if D_0_index==length(D_0_matrix)
...
%             cutoff_mask(i,:)=(transition_rate_Kramer_eff(i,:)>1/time_duration(1)); % masking for rate > 1/time_duration
            pre_mask_2Kramers(i,:)=pre_filter(rateN_eff_2D(i,:),transition_rate_Kramer_eff(i,:),error).*cutoff_mask(i,:);
            plot3(ones(length(theta_0_1D_matrix))*D_0*delta_t_matrix(i),theta_0_matrix(i,:),trans_rate_sim_2D(i,:).*iF(-1+theta_0_matrix(i,:))./(trans_rate_measured(i,:).*iF(-1+theta_0_matrix(i,:))).*pre_mask_2Kramers(i,:),'-.g')
            plot3(ones(length(theta_0_1D_matrix))*D_0*delta_t_matrix(i),theta_0_matrix(i,:),trans_rate_sim_2D(i,:).*iF(-1+theta_0_matrix(i,:))./(transition_rate_Kramer(i,:).*iF(-1+theta_0_matrix(i,:))).*pre_mask_2Kramers(i,:),'-.r')
            plot3(ones(length(theta_0_1D_matrix))*D_0*delta_t_matrix(i),theta_0_matrix(i,:),trans_rate_sim_2D(i,:).*iF(-1+theta_0_matrix(i,:))./(transition_rate_Kramer_eff(i,:).*iF(-1+theta_0_matrix(i,:))).*pre_mask_2Kramers(i,:),':b')
        end
        if D_0_index==length(D_0_matrix)
%         v = [5 2 5];
        v = [1 0 0];
...
%                 end
        ...
        for i=1:length(delta_t_matrix)
            ...
            plot3(ones(length(theta_0_1D_matrix))*D_0*delta_t_matrix(i),theta_0_matrix(i,:),trans_rate_sim_2D(i,:).*iF(-1+theta_0_matrix(i,:))./(rateN_measured_2D(i,:).*iF(-1+theta_0_matrix(i,:))).*pre_mask_2numeric(i,:),'-.g')
            plot3(ones(length(theta_0_1D_matrix))*D_0*delta_t_matrix(i),theta_0_matrix(i,:),trans_rate_sim_2D(i,:).*iF(-1+theta_0_matrix(i,:))./(rateN_2D(i,:).*iF(-1+theta_0_matrix(i,:))).*pre_mask_2numeric(i,:),'-.r')
            plot3(ones(length(theta_0_1D_matrix))*D_0*delta_t_matrix(i),theta_0_matrix(i,:),trans_rate_sim_2D(i,:).*iF(-1+theta_0_matrix(i,:))./(rateN_eff_2D(i,:).*iF(-1+theta_0_matrix(i,:))).*pre_mask_2numeric(i,:),':b')
...
% %% Closing all the single figures
% switch single_plots
%     case 'off'
%         switch part1
%             case 'on'
