...
compare_PC(D_0,dt,tau_matrix,10*[11:0.5:20],10^5)
% compare_PC(D_0,dt,[2:0.2:4],5,10^6)

%% Part 1, from modified_average_rate... from Viktor

% load(['2021.1.25_compare_vik,D_0=',num2str(D_0),',tau=0.1.mat'],'AvN_plot','AratesV_plot','rateA_plot','rateAeff_plot','rateN_plot','iF')
...
% load(['2021.1.25_compare_PC,D_0=',num2str(D_0),',tau=0.1.mat'])
