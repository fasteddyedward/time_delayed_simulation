function [num_transitions_matrix,theta_plus_matrix,theta_minus_matrix,R_matrix,D_omega_matrix,D_theta_matrix,theta_0_matrix,R_recip_matrix]= Scan_main(Date,nth_take,delta_t_matrix,T_matrix,v_0_matrix,dt,intrinsic_delay,Obs_time_steps,D_0)
%% Matrices to append
...
% theta_0_matrix=[];
% R_recip_matrix=[];
num_transitions_matrix(1:length(v_0_matrix),1:length(delta_t_matrix))=0;
theta_plus_matrix(1:length(v_0_matrix),1:length(delta_t_matrix))=0;
theta_minus_matrix(1:length(v_0_matrix),1:length(delta_t_matrix))=0;
R_matrix(1:length(v_0_matrix),1:length(delta_t_matrix))=0;
D_omega_matrix(1:length(v_0_matrix),1:length(delta_t_matrix))=0;
D_theta_matrix(1:length(v_0_matrix),1:length(delta_t_matrix))=0;
theta_0_matrix(1:length(v_0_matrix),1:length(delta_t_matrix))=0;
R_recip_matrix(1:length(v_0_matrix),1:length(delta_t_matrix))=0;
%%
...
num_transitions_matrix(v_0_index,delta_t_index)=num_transitions_theta;
theta_plus_matrix(v_0_index,delta_t_index)=theta_plus;
theta_minus_matrix(v_0_index,delta_t_index)=theta_minus;
R_matrix(v_0_index,delta_t_index)=R_mean;
D_omega_matrix(v_0_index,delta_t_index)=D_omega2;
D_theta_matrix(v_0_index,delta_t_index)=D_theta;
theta_0_matrix(v_0_index,delta_t_index)=theta_0;
R_recip_matrix(v_0_index,delta_t_index)=R_recip;
